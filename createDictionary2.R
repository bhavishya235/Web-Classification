library("tm")
library("SnowballC")
(dict.sample = Corpus(DirSource("datafiles/dictionaryCorpus2", encoding = "UTF-8")))
...
#save in a file
write(x=t(dict.allWords), file="datafiles/Dictionary2.txt", sep="\t")
write.table(x=dict.wordFreq,file="datafiles/DictionaryFrequency2.txt",quote=FALSE,sep="\t")
